...
rewrite_prompt = ChatPromptTemplate.from_messages([
    (
        ...
        (
            ...
            "  7. GPA must be copied exactly as it appears — do not append anything like "
            "'Cum Laude', 'with Honours', or any classification not in the resume.\n"
            "  8. Date fields must be copied exactly — do not prepend 'Expected Graduation:', "
            "'Expected:', or any prefix not in the original resume.\n\n"
